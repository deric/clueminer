 ...
 * purposes. Used with
 * <code>LMAMultiDim</code>. For simpler, one dimensional fit functions you can
 * use
 * <code>LMAFunction</code> with
 * <code>LMA</code>.
 *
...
public abstract class LMAMultiDimFunction {
     ...
     * can't calculate the derivate, use a small
     * <code>a</code>-step (e.g., <i>da</i> = 1e-20) and return <i>dy/da</i> at
     * the given <i>x</i> for each fit parameter.
     *
     * @return The partial derivate of the function with respect to
     * parameter <code>parameterIndex</code> at <i>x</i>.
     * @param x The <i>x</i>-value for which the partial derivate is calculated.
     * @param a The fitting parameters.
     * @param parameterIndex The parameter index for which the partial derivate
     * is calculated.
     */
