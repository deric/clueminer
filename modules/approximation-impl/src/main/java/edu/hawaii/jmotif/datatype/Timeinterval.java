...
/**
 * The timeinterval implementation.
 *
 * @author Pavel Senin
 *
 */
public final class Timeinterval implements Comparable<Timeinterval> {
    ...
    /**
     * Compares the TimeInterval object with other TimeInterval using START
     * timestamps first: i.e. by the timestamp values, if they are equal, the
     * END values or VALUE used.
     *
