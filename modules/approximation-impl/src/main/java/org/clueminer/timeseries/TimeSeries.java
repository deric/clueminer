...
import org.clueminer.util.Arrays;
...
public class TimeSeries {
    ...
    public TimeSeries(File inputFile, boolean isFirstColTime, boolean isLabeled, char delimiter) {
    ...
    public TimeSeries(String inputFile, boolean isFirstColTime, boolean isLabeled, char delimiter) {
        this(new File(inputFile), ZERO_ARRAY, isFirstColTime, isLabeled, delimiter);
    }
    ...
    public TimeSeries(String inputFile, int[] colToInclude, boolean isFirstColTime, boolean isLabeled, char delimiter) {
        this(new File(inputFile), colToInclude, isFirstColTime, isLabeled, delimiter);
    }
