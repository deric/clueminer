 ...
 *
 * <p>In general,
 * <code>JCustomTooltip</code> can be used with any Swing widget. This is done
 * by overriding JComponent's
 * <code>createToolTip</code> method such that it returns the custom tooltip
 * instance.</p>
 *
 * <p>Before using this class, you might first check if you can achieve your
 ...
 * See See <a
 * href="http://examples.oreilly.com/jswing2/code/ch04/HtmlLabel.java">
 * this example</a> for an instance of using HTML formatting in a JLabel. The
 * same HTML string could be used as the input to JComponent's
 * <code>setToolTipText</code> method.</p>
 *
 * @author <a href="http://jheer.org">jeffrey heer</a>
 */
public class JCustomTooltip extends JToolTip {

    private static final long serialVersionUID = 304574415026151461L;
