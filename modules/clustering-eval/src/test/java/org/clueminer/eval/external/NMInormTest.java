 ...
 * @author deric
 */
public class NMInormTest extends ExternalTest {

    private static Clustering irisCorrect;
    private static Clustering irisWrong;

    public NMInormTest() throws FileNotFoundException, IOException {
    ...
    public void testScore_Clustering_Clustering() throws ScoreException {
        ...
        double score = measure(irisWrong, irisCorrect, 0.6545182434318744);

        double score2 = measure(FakeClustering.irisWrong(), irisCorrect, 0.08795125619873);
