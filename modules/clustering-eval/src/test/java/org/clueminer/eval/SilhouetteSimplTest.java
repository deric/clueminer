 ...
 * @author deric
 */
public class SilhouetteSimplTest {

    private final SilhouetteSimpl subject;
    private static final double DELTA = 1e-9;

    public SilhouetteSimplTest() {
        subject = new SilhouetteSimpl();
    }

    @Test
    public void testIris() throws ScoreException {
        double scoreBetter = subject.score(FakeClustering.iris());
        assertEquals(0.6519912244646413, scoreBetter, DELTA);
