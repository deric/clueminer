...
public class NMIjointTest extends ExternalTest {
    ...
    public void testScore_Clustering_Clustering() throws ScoreException {
        ...
        double score = measure(irisWrong, irisCorrect, 0.4811326229762928);

        double score2 = measure(FakeClustering.irisWrong(), irisCorrect, 0.03516294406379005);
    ...
    public void testScore_Clustering_Dataset() throws ScoreException {
        ...
        double score = measure(irisWrong, 0.4811326229762928);
        double score2 = measure(FakeClustering.irisWrong(), irisCorrect, 0.03516294406379005);
    ...
    public void testHandle() {
        assertEquals("nmi_joint", subject.getHandle());
    }
