 ...
 * @author deric
 */
public class AMImaxTest extends ExternalTest {

    private static Clustering irisCorrect;
    private static Clustering irisWrong;

    public AMImaxTest() throws FileNotFoundException, IOException {
    ...
    public void testScore_Clustering_Clustering() throws ScoreException {
        ...
        double score = measure(irisWrong, irisCorrect, 0.579380164285695);

        double score2 = measure(FakeClustering.irisWrong(), irisCorrect, 0.04154944965048758);
