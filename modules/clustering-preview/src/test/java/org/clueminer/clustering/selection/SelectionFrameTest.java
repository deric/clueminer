 ...
 * @author deric
 */
public class SelectionFrameTest {

    private final SelectionFrame subject;

    public SelectionFrameTest() {
        subject = new SelectionFrame();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new SelectionFrameTest().showInFrame();
            }
        });
    }
}
