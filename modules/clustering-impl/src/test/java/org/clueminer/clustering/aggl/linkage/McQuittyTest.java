 ...
 * @author deric
 */
public class McQuittyTest extends AbstractLinkageTest {

    public McQuittyTest() {
        subject = new McQuitty();
    }
...
//        assertEquals(61.79021281724145, root.getHeight(), delta);
        ...
        assertEquals(76.23872531412829, lance.getTreeData().getRoot().getHeight(), delta);
    ...
    public void testBeta() {
        assertEquals(0.0, subject.beta(2, 2, 99), delta);
    }
