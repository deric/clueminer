 ...
 * @author deric
 */
public class CentroidLinkageTest extends AbstractLinkageTest {

    public CentroidLinkageTest() {
        subject = new CentroidLinkage();
    }
...
//        assertEquals(61.79021281724145, root.getHeight(), delta);
    ...
    public void testAlphaA() {
        assertEquals(0.25, subject.alphaA(1, 3, 99), delta);
    }

    @Test
    public void testAlphaB() {
        assertEquals(0.5, subject.alphaB(4, 4, 1), delta);
    }
