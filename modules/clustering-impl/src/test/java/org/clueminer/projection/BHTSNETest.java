 ...
 * @author deric
 */
public class BHTSNETest<E extends Instance> {

    private BHTSNE subject;
    private int initialDims = 50;
    private static double perplexity = 20.0;
    private static Logger LOG = LoggerFactory.getLogger(BHTSNETest.class);
