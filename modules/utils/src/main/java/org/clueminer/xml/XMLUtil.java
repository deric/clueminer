 ...
 /*   public static Element addChartNode(Document document, Element parent, Chart chart) {
  ...
  /*  public static Element addOverlayNode(Document document, Element parent, Overlay overlay) {
    ...
    public static int getIntegerProperty(Element properties, String name) {
        return new Integer(getPropertyNode(properties, name).getAttributes().getNamedItem(INTEGER_ATTR).getNodeValue());
    }
    ...
    public static double getDoubleProperty(Element properties, String name) {
        return new Double(getPropertyNode(properties, name).getAttributes().getNamedItem(DOUBLE_ATTR).getNodeValue());
    }
    ...
    public static boolean getBooleanProperty(Element properties, String name) {
        return Boolean.parseBoolean(getPropertyNode(properties, name).getAttributes().getNamedItem(BOOLEAN_ATTR).getNodeValue());
    }

    public static void addColorProperty(Document document, Element parent, String name, Color value) {
        addPropertyNode(document, parent, name).setAttribute(COLOR_ATTR, value.getRed() + "," + value.getGreen() + "," + value.getBlue());
    }

    public static Color getColorProperty(Element properties, String name) {
        String[] rgb = getPropertyNode(properties, name).getAttributes().getNamedItem(COLOR_ATTR).getNodeValue().split(",");
        return new Color(
                new Integer(rgb[0]),
                new Integer(rgb[1]),
                new Integer(rgb[2]));
    ...
    public static void addFontProperty(Document document, Element parent, String name, Font value) {
        addPropertyNode(document, parent, name).setAttribute(FONT_ATTR, value.getName() + "," + value.getStyle() + "," + value.getSize());
    }

    public static Font getFontProperty(Element properties, String name) {
        String[] font = getPropertyNode(properties, name).getAttributes().getNamedItem(FONT_ATTR).getNodeValue().split(",");
