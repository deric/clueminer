 ...
 * @author deric
 */
public class PAMDialogTest {

    private final PAMDialog subject;

    public PAMDialogTest() {
        subject = new PAMDialog();
    }

    @Test
    public void testIsUIfor() {
        assertEquals(true, subject.isUIfor(new PAM(), null));
    }
