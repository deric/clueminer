...
public class Plot2DPanel extends PlotPanel {
    ...
    private static final long serialVersionUID = -3088119088420819597L;
     ...
     *
     * @param name Name for the plot, which will be used in the legend. (String)
     * @param color Plot color. (Color)
     * @param XY Pairs of array of double. First one contains the X position of
     * the data points, second contains Y position. <br> Each array of the pair
     * must be of the same length; if not a ArrayIndexOutOfBoundsException
     * exception will be thrown. <br> Each data set must come in <b>pair</b> of
     * array of double; if not a ArrayIndexOutOfBoundsException exception will
     * be thrown.
     ...
     * @param name Name for the plot, which will be used in the legend. (String)
     * @param color Plot color. (Color)
     * @param XYdXdY m*4 array of array of double. Contains the x,y coordinates
     * of the m boxes' center and the boxes width and heigth (m lines, 4 rows).
     * @return the index of the plot in the panel (int).
     * @see #addScatterPlot(String,Color,double[]...)
     * @see #addBarPlot(String, Color, double[]...)
     * @see #addStaircasePlot(String, Color, double[]...)
     ...
     * @param name Name for the plot, which will be used in the legend. (String)
     * @param color Plot color. (Color)
     * @param XY m*2 array of array of double. Contains the x coordinate and the
     * heigth of each bar (m lines, 2 rows).
     ...
     *
     * @param name Name for the plot, which will be used in the legend. (String)
     * @param XYdX m*3 array of array of double. Contains the x coordinate, the
     * heigth of each bar and the width of each bar (m lines, 3 rows).
     * @return the index of the plot in the panel (int).
     * @see #addScatterPlot(String,Color,double[]...)
     * @see #addBarPlot(String, Color, double[]...)
     * @see #addStaircasePlot(String, Color, double[]...)
