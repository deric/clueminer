...
/**
 * Interconnectivity part from Shatovska formula for computing pairs' similarity
 *
 * @author deric
 */
@ServiceProvider(service = MergeEvaluation.class)
public class ICS<E extends Instance> extends AbstractSimilarity<E> implements MergeEvaluation<E> {

    public static final String name = "ICS";
