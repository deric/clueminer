...
public class BBKnd<E extends Instance> extends AbstractSimilarity<E> implements MergeEvaluation<E> {

    public static final String NAME = "BBK-ND";
    ...
    public void clusterCreated(Pair<? extends Cluster<E>> pair, Cluster<E> c, Props params) {
        ...
        newCluster.setDistanceSum(cluster1.getDistanceSum() + cluster2.getDistanceSum());
    }
}
