...
import org.clueminer.graph.knn.DirectedKnnBuilder;
...
public class ChameleonDialog extends JPanel implements ClusteringDialog {
    ...
    public ChameleonDialog() {
        ...
        comboGraphConvertor.setSelectedItem(DirectedKnnBuilder.NAME);
        comboKnn.setSelectedItem("linear k-nn");
        comboIncludeEdges.setSelectedItem("bidirect");
    }
    ...
    private void initComponents() {
        ...
        lbGraphConv = new javax.swing.JLabel();
        comboGraphConvertor = new javax.swing.JComboBox<>();
        ...
        chckFloodFill = new javax.swing.JCheckBox();
        ...
        comboKnn.setModel(new DefaultComboBoxModel(initKnn()));

        org.openide.awt.Mnemonics.setLocalizedText(lbEdgeValue, org.openide.util.NbBundle.getMessage(ChameleonDialog.class, "ChameleonDialog.lbEdgeValue.text")); // NOI18N
        ...
        chckFloodFill.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(chckFloodFill, org.openide.util.NbBundle.getMessage(ChameleonDialog.class, "ChameleonDialog.chckFloodFill.text")); // NOI18N
    ...
    private javax.swing.JCheckBox chckFloodFill;
    ...
    private javax.swing.JLabel lbEdgeValue;
    private javax.swing.JLabel lbGraphConv;
    ...
    public Props getParams() {
        ...
        params.putBoolean("flood-fill", chckFloodFill.isSelected() ? true : false);
    ...
    private Object[] initGraphConvertor() {
        return GraphConvertorFactory.getInstance().getProvidersArray();
    }
