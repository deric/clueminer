 ...
 * @param <C>
 */
public class ClusteringPlot<E extends Instance, C extends Cluster<E>> extends JPanel {

    private int markerSize = 10;
    private Chart currChart;
    private String title = null;
    private boolean simple = true;
    private static final Logger LOG = LoggerFactory.getLogger(ClusteringPlot.class);

    public ClusteringPlot() {
        initComponents();
    }
    ...
    private JPanel clusteringPlot(final Clustering<E, C> clustering) {
        ...
        SimplePlot xchart = new SimplePlot(chart);
        return xchart;
    }
