 ...
 */
public class ScatterMatrixGralPanel extends JPanel {

    private static final long serialVersionUID = 4957672836007726620L;

    private final Shape shape = new Ellipse2D.Double(-3, -3, 6, 6);
    private static final Logger logger = Logger.getLogger(ScatterMatrixGralPanel.class.getName());
    private LegendGral legend;

    public ScatterMatrixGralPanel() {
        initComponents();
    }

    private void initComponents() {
        setLayout(new GridBagLayout());
        legend = new LegendGral();
