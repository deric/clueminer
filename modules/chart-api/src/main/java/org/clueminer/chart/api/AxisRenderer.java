...
/**
 * Interface for generic renderer of axes.
 */
public interface AxisRenderer {
     ...
     * This doesn't influence ticks or labels.
     *
     * @param shapeVisible {@code true} if the shape should be drawn, false
     *                     otherwise.
     */
     ...
     *
     * @return {@code true} if the orientation is clockwise, {@code false} if it
     *         is
     *         counterclockwise.
     */
    ...
    /**
     * Returns whether the interval for major and minor ticks is chosen
     * automatically.
     *
    ...
    /**
     * Sets whether the interval for major and minor ticks is chosen
     * automatically.
     *
     * @param autoSpaced {@code true} if auto-spacing is enabled, {@code false}
     *                   otherwise.
     */
     ...
     *
     * @return {@code true} if tick labels will be drawn, {@code false}
     *         otherwise.
     */
     ...
     *
     * @param tickLabelsVisible {@code true} if tick labels will be drawn,
     *                          {@code false} otherwise.
     */
     ...
     *
     * @return {@code true} if the labels are drawn outside of the plot,
     *         {@code false} otherwise.
     */
     ...
     *
     * @param tickLabelsOutside {@code true} if the labels are drawn outside of
     *                          the plot,
     *                          {@code false} otherwise.
     */
     ...
     *
     * @param minorTicksVisible {@code true} if minor ticks are drawn,
     *                          {@code false} otherwise.
     */
