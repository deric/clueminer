package org.clueminer.chart.legends;
...
public interface Legend extends Container, Drawable {
     ...
     * @return {@code true} if legend contains the data source, otherwise
     *         {@code false}
     */
     ...
     * {@code 0.0} means left, {@code 0.5} means centered, and {@code 1.0} means
     * right.
     *
     ...
     * {@code 0.0} means top, {@code 0.5} means centered, and {@code 1.0} means
     * bottom.
     *
