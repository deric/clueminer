...
class MagicMimeEntry {
    		...
    		throws InvalidMagicMimeEntryException
    {
    	...
    	if(parent != null) {
    		...
    		parent.hashCodeCache = 0;
    		parent.toStringCache = null;
    	}
...
//                buf.put(buf.array(), startPos, 1);
	...
	public boolean equals(Object obj) {
		...
		MagicMimeEntry other = (MagicMimeEntry) obj;
    ...
    public int hashCode() {
    	if (hashCodeCache == 0) {
    		final int prime = 31;
    		int h = 1;
//    		h = prime * h + ((operation == null) ? 0 : operation.hashCode());
//    		for (Iterator it = subEntries.iterator(); it.hasNext(); ) {
//        		MagicMimeEntry subEntry = (MagicMimeEntry) it.next();
//        		h = prime * h + subEntry.hashCode();
//        	}
    		h = prime * h + toString().hashCode();
    		hashCodeCache = h;
    	}
