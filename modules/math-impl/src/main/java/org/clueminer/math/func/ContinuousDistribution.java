...
import org.clueminer.math.Romberg;
...
public abstract class ContinuousDistribution extends Distribution {
    ...
    public double mean() {
        ...
        return Romberg.romb(new FunctionBaseImpl(), intMin, intMax);
    }
     ...
     */
    abstract public void setUsingData(Vector<Double> data);
    ...
    private class FunctionBaseImpl extends FunctionBase {

        private static final long serialVersionUID = 53587533420793481L;

        public FunctionBaseImpl() {
        }
