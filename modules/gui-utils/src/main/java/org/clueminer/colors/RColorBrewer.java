...
public enum RColorBrewer {
    ...
    private final boolean colorBlindSave;

    RColorBrewer(int paletteType, String paletteDescription, boolean colorBlindSave, int[][] hexColors) {
    ...
    public static RColorBrewer[] getSequentialColorPalettes(boolean colorBlindSave) {
        return getPalettes(3, colorBlindSave);
    }

    public static RColorBrewer[] getDivergingColorPalettes(boolean colorBlindSave) {
        return getPalettes(1, colorBlindSave);
    }

    public static RColorBrewer[] getQualitativeColorPalettes(boolean colorBlindSave) {
        return getPalettes(2, colorBlindSave);
    }

    private static RColorBrewer[] getPalettes(int paletteType, boolean colorBlindSave) {
        List<RColorBrewer> palettes = new ArrayList<>();

        if (colorBlindSave) {
            for (RColorBrewer palette : values()) {
        ...
        return palettes.toArray(new RColorBrewer[0]);
    }
