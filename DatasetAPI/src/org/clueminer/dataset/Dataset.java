...
import org.clueminer.instance.InstanceBuilder;
...
public interface Dataset<E extends Instance> extends Cloneable, Serializable, Iterable<E>, Collection<E> {
     ...
     * @return usually it is a number, however to make it more universal, we
     * use string
     */
    public String getId();
    ...
    /**
     * During data preprocessing it is quite common to try different ways
     * of preprocessing and therefore generate a few datasets from the original
