...
public class InterpolationSearchTest {
    ...
    public void testSearch() {
        Numeric[] sortedArray = new TimePointAttribute[5];
        sortedArray[0] = new TimePointAttribute(0, 1, 1.5F);
        sortedArray[1] = new TimePointAttribute(1, 2, 2F);
        sortedArray[2] = new TimePointAttribute(2, 3, 5F);
        sortedArray[3] = new TimePointAttribute(3, 4, 10F);
        sortedArray[4] = new TimePointAttribute(4, 5, 15F);
