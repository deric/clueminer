...
public class JMatrixTest {
    ...
    public void testConstructWithCopy() {
        ...
        R = MatrixHelper.random(A.getRowDimension(), A.getColumnDimension());
        A = R;
        try {
            S = A.minus(S);
        ...
        A = R.copy();
        B = MatrixHelper.random(A.getRowDimension(), A.getColumnDimension());
        C = A.minus(B);
        try {
            S = A.plus(S);
    ...
    /**
     * Test of getRowDimension method, of class JMatrix.
     */
    @Test
    ...
    /**
     * Test of getColumnDimension method, of class JMatrix.
     */
    @Test
    ...
    /**
     * Test of lu method, of class JMatrix.
     */
    @Test
    public void testLu() {
    }
    ...
    /**
     * Test of qr method, of class JMatrix.
     */
    @Test
    public void testQr() {
    }
    ...
    /**
     * Test of chol method, of class JMatrix.
     */
    @Test
