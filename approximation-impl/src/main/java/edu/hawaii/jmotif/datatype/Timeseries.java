...
/**
 * Implements time-series. It's important to understand how it handles NaN
 * values. If input data has NaN's or INFINITY's as entries it will be kept
 * same, but if you specify particular numeric value as NaN, it'll be converted
 * into Double.NaN internally and you have to convert it back to your number
 * later..
 *
 * @author Pavel Senin.
 *
...
public final class Timeseries implements Iterable<TPoint>, Cloneable, Serializable {
    ...
    /**
     * Add the point at the end of the timeseries. No consistency check is
     * conducted.
     *
    ...
    /**
     * Add the point to the timeseries, inserting it at the position specified
     * by the timestamp.
     *
     * @param p The point to add.
     */
    ...
    /**
     * Extract interval from timeseries. It is inclusive, i.e. subsection(0,5)
     * will include 6 elements from ts[0] to ts[5].
     *
