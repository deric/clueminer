...
/**
 * The trie structure following the Keogh's and Lin discords discovery article.
 * It is an extension of the Trie class by adding the array of all occurrences
 * in order to speed-up search process to the Magic.
 *
 * @author Pavel Senin
 *
 */
public class SAXTrie {
     ...
     * Constructor.
     *
     * @param seqLength The sequence length - this parameter is needed for the
     * proper array allocation.
     * @param alphabetSize The alphabet size to use for the trie tree
     * construction.
    ...
    /**
     * Get all frequencies stored in this instance. It will not return the
     * occurrences. You need to ask for them.
     *
