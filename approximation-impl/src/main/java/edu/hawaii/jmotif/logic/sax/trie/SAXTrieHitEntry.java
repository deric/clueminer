...
/**
 * The implementation of the magic array structure. It should contain all of the
 * words obtained by sliding window over the timeseries.
 *
 * @author Pavel Senin.
 *
 */
public class SAXTrieHitEntry implements Comparable<SAXTrieHitEntry> {
     ...
     *
     * @param complexity If 1 - single letter used, 2 - two or more letters, 3 -
     * 3 or more etc..
     *
    ...
    public int compareTo(SAXTrieHitEntry arg0) {
        if (null == arg0) {
            throw new NullPointerException("Unable to compare with null object.");
        }
