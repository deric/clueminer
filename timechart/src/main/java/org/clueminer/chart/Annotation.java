...
public abstract class Annotation implements Serializable, MouseListener, MouseMotionListener {
    ...
    private static final long serialVersionUID = 3615702597059886117L;
    ...
    protected int getTimeIndex(long t) {
        ...
        if (idx == null) {
            ...
            //    long max = cd.getSamples().getLastTime();
    ...
    protected boolean hasNext(long t) {
        int items = config.getChartData().getTimePointsCnt();
    ...
    protected long getNext(long t) {
        ...
        return 0;//chartFrame.getChartData().getSamples().getTimeAt(i + 1);
    }
    ...
    public Rectangle[] getUpdateRectangles() {
        ...
        System.arraycopy(updateRects, 0, r, 0, size);
