...
public class CoordCalc {
    ...
    public static Line2D.Double line(double x, double y, double width, double height) {
        return new Line2D.Double(x, y, width, height);
    }

    public static Ellipse2D.Double circle(double x1, double y1, double x2, double y2) {
